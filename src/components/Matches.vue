        ...
        <td class="px-6 py-4 whitespace-nowrap">
          <button class="text-red-600 hover:text-red-900" @click="remove(i)">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
              <path fill-rule="evenodd" d="M6 2a1 1 0 00-1 1v1H3a1 1 0 100 2h1v9a2 2 0 002 2h8a2 2 0 002-2V6h1a1 1 0 100-2h-2V3a1 1 0 00-1-1H6zm3 3a1 1 0 112 0v1a1 1 0 11-2 0V5zM5 8a1 1 0 011-1h8a1 1 0 011 1v7a1 1 0 11-2 0V9H7v6a1 1 0 11-2 0V8z" clip-rule="evenodd" />
            </svg>
          </button>
        </td>
      </tr>
